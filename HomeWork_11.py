...
class Record:
    ...
    def __str__(self):
        return f"{self.name}: {', '.join(self.phone)}: {self.birthday}"

    def __repr__(self):
        phones = ', '.join(str(phone.value) for phone in self.phones)
        return f"{self.name.value}: {phones}: {self.birthday}"
...
if __name__ == "__main__":
    ...
    name = Name("Jill")
    phone = Phone("(097) 007-0007")
    phone_2 = Phone("(097) 007-0007")
    bd_2 = Birthday("10.12.2022")
    record_2 = Record(name, phone, bd_2)
    record_2.add(phone_2)
    second.add_record(record_2)
    print(second)
    ...
    phone = Phone("(097) 007-0007")
    phone_2 = Phone("(097) 007-0007")
    record_3 = Record(name, phone)
    record_3.add(phone_2)
    third.add_record(record_3)
    print(third)
